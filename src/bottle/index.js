...
let createScene = async function () {
    ...
    async function createMaterials() {
        ...
        await sodaMats.bottle.loadAsync("https://patrickryanms.github.io/BabylonJStextures/Demos/sodaBottle/assets/shaders/glassShader.json");
        sodaMats.bottle.build(false);

        sodaMats.liquid = new BABYLON.NodeMaterial("sodaMat", scene, { emitComments: false });
        await sodaMats.liquid.loadAsync("https://patrickryanms.github.io/BabylonJStextures/Demos/sodaBottle/assets/shaders/sodaShader.json");
        ...
        bottleParameters.glassTint.value = bottleParameters.labelGlassTint.value = BABYLON.Color3.FromHexString("#aaaaaa");
    ...
    generateShadows();
    console.log(scene,lights,env,bottle,table,sodaMats,bottleTex,liquidTex,bottleParameters,liquidParameters,shadows)
